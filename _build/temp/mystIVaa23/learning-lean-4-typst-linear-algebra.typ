...
A scratch chapter for linear-algebra notes — enough structure to flesh out later, and enough variety (numbered equations, a table, admonitions, and interleaved Lean) to show the book template in action. The runnable code lives in #link("/LinearAlgebra-878b28eab3a3624c7b18d16936039f2a.lean")[`LearningLean/LinearAlgebra.lean`].
